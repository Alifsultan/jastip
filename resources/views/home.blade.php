    ...
    <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img src="{{asset('assets/img/photo1.png')}}" class="img-fluid w-100" id="gambar_slider"
                    alt="First slide">
            </div>
                        ...
                        <tr>
                            ...
                            <td bgcolor="red">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <input type="text" name="nama" id="exampleFormControlInput1"
                        ...
                        <tr>
                            ...
                            <td bgcolor="red">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <br>
                                    <button type="button" onClick='inputdata()' class="btn btn-success">Check</button>
                                </div>
                            </td>
                </div>
                </tr>
