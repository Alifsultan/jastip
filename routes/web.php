...
Route::get('changeStatus', [staffController::class, 'changeStatus'])->name('changeStatus');
...
})->middleware(['checkRole:kurir,staff']);
...
Route::group(['middleware' => 'checkRole:staff'], function () {
    ...
    Route::resource('barang', BarangController::class)->names([
        ...
        'barangEdit' => 'edit',
        'barangUpdate' => 'update',
        'barangDestroy' => 'destroy',
    ]);
    Route::resource('/barang', \App\Http\Controllers\BarangController::class);
});


Route::get('barangIndex', [BarangController::class, 'barangIndex'])->name('barangIndex');
Route::get('create', [BarangController::class, 'create'])->name('create');
Route::get('kirim', [BarangController::class, 'kirim'])->name('kirim');
